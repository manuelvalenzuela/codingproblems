...
namespace CodingProblemsTests
{
    public class TheClockwiseSpiralTests
    {
        ...
        {
            var expected = new[,] { { 1 } };
            Assert.Equal(expected, TheClockwiseSpiral.CreateSpiral(1));
        }
        ...
        public void Test2()
        {
            ...
            Assert.Equal(expected, TheClockwiseSpiral.CreateSpiral(2));
        }
        ...
        public void Test3()
        {
            ...
            Assert.Equal(expected, TheClockwiseSpiral.CreateSpiral(3));
        }
        ...
        public void Test4()
        {
            ...
            Assert.Equal(expected, TheClockwiseSpiral.CreateSpiral(4));
        }
        ...
        public void Test5()
        {
            ...
            Assert.Equal(expected, TheClockwiseSpiral.CreateSpiral(5));
        }
        ...
        public void Test19()
        {
            ...
            Assert.Equal(expected, TheClockwiseSpiral.CreateSpiral(19));
        }
